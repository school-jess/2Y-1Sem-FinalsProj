...
namespace SmartLibraryManagementSystemClassLibrary.Migrations
{
    ...
    [Migration("20251125131022_AddedSessionDataTable")]
    partial class AddedSessionDataTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLibraryManagementSystemClassLibrary.Model.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("ReservationReturnDateTime")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("SmartLibraryManagementSystemClassLibrary.Model.SessionData", b =>
                {
            ...
            modelBuilder.Entity("SmartLibraryManagementSystemClassLibrary.Model.Faculty", b =>
                {
                    b.HasOne("SmartLibraryManagementSystemClassLibrary.Model.User", "User")
                        .WithOne("Faculty")
                        .HasForeignKey("SmartLibraryManagementSystemClassLibrary.Model.Faculty", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartLibraryManagementSystemClassLibrary.Model.Student", b =>
                {
                    b.HasOne("SmartLibraryManagementSystemClassLibrary.Model.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("SmartLibraryManagementSystemClassLibrary.Model.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
